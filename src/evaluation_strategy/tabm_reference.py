...
# Optimization
# ======================================================================================
def default_zero_weight_decay_condition(mn, m, pn, p):
    return isinstance(m, (nn.BatchNorm1d, nn.BatchNorm2d, nn.LayerNorm))
...
class Model(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        n_classes: Optional[Tensor],
        backbone: dict,
        bins: Optional[Tensor],  # For piecewise-linear encoding/embeddings.
